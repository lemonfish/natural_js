(function(window, $){
	...
	(function(N){
		...
		function peg$parse(input, options) {
			...
			var peg$f2 = function() { return e.charAt(0); };
			var peg$f3 = function(e) { return e.charAt(0); };
			...
			var peg$f7 = function(attr) { return { type: 'attr', name: attr }; };
			...
			var peg$f12 = function(w, w2) {
				return w + w2.join("");
			};
			var peg$f13 = function() { return true; };
			var peg$f14 = function() { return false; };
			var peg$f15 = function() { return N; };
			var peg$f16 = function() { return Math; };
			var peg$f17 = function(n1, dot, n2) {
			...
			var peg$f19 = function(e) { return this[e]; };
			...
			function peg$parse고정문자열() {
				...
				if (s0 === peg$FAILED) {
					...
					if (s1 !== peg$FAILED) {
						peg$savedPos = s0;
						s1 = peg$f2.call(options.context);
					}
					s0 = s1;
					if (s0 === peg$FAILED) {
						s0 = peg$currPos;
						...
						if (s1 !== peg$FAILED) {
							peg$savedPos = s0;
							s1 = peg$f3.call(options.context, s1);
						}
						s0 = s1;
					}
				}
			...
			function peg$parse표현식영역() {
				...
				if (s1 !== peg$FAILED) {
					...
					if (s3 !== peg$FAILED) {
						...
						if (s5 !== peg$FAILED) {
							peg$savedPos = s0;
							s0 = peg$f4.call(options.context, s3);
						} else {
							peg$currPos = s0;
							s0 = peg$FAILED;
						}
			...
			function peg$parse표현식요소() {
				...
				if (s1 !== peg$FAILED) {
					...
					peg$savedPos = s0;
					s0 = peg$f6.call(options.context, s1, s2);
				} else {
					peg$currPos = s0;
					s0 = peg$FAILED;
				}
			...
			function peg$parse속성() {
				...
				if (s1 !== peg$FAILED) {
					...
					if (s2 !== peg$FAILED) {
						peg$savedPos = s0;
						s0 = peg$f7.call(options.context, s2);
					} else {
						peg$currPos = s0;
						s0 = peg$FAILED;
					}
				...
				if (s0 === peg$FAILED) {
					...
					if (s1 !== peg$FAILED) {
						...
						if (s3 !== peg$FAILED) {
							...
							if (s5 !== peg$FAILED) {
								peg$savedPos = s0;
								s0 = peg$f8.call(options.context, s3);
							} else {
								peg$currPos = s0;
								s0 = peg$FAILED;
							}
			...
			function peg$parse함수() {
				...
				if (s1 !== peg$FAILED) {
					...
					if (s3 !== peg$FAILED) {
						...
						if (s7 !== peg$FAILED) {
							peg$savedPos = s0;
							s0 = peg$f10.call(options.context, s1, s5);
						} else {
							peg$currPos = s0;
							s0 = peg$FAILED;
						}
			...
			function peg$parse식별자() {
				...
				if (s1 !== peg$FAILED) {
					...
					peg$savedPos = s0;
					s0 = peg$f12.call(options.context, s1, s2);
				} else {
					peg$currPos = s0;
					s0 = peg$FAILED;
				}
				...
				if (s0 === peg$FAILED) {
					...
					if (s0 === peg$FAILED) {
						...
						if (s0 === peg$FAILED) {
							...
							if (s1 !== peg$FAILED) {
								peg$savedPos = s0;
								s1 = peg$f16.call(options.context);
							}
							s0 = s1;
						}
					}
			...
			function peg$parse표현식_숫자() {
				...
				if (s1 !== peg$FAILED) {
					...
					peg$savedPos = s0;
					s0 = peg$f17.call(options.context, s1, s2, s3);
				} else {
					peg$currPos = s0;
					s0 = peg$FAILED;
				}
			...
			function peg$parse표현식_문자열() {
				...
				if (s1 !== peg$FAILED) {
					...
					if (s3 !== peg$FAILED) {
						peg$savedPos = s0;
						s0 = peg$f18.call(options.context, s2);
					} else {
						peg$currPos = s0;
						s0 = peg$FAILED;
					}
			...
			function peg$parse표현식_변수() {
				...
				if (s0 === peg$FAILED) {
					...
					if (s1 !== peg$FAILED) {
						peg$savedPos = s0;
						s1 = peg$f19.call(options.context, s1);
					}
					s0 = s1;
				}
